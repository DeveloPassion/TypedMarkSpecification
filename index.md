...
- [Collection Model](collection-model.md): the collection configuration file — how notes get their types, require tags, reuse shared structure, and declare automation rules
