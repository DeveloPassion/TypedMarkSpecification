...
- [Schema Reuse](schema-reuse.md): abstract inheritance and conditional constraints
...
See [Schema Reuse](schema-reuse.md) for the authoritative contract and examples.
